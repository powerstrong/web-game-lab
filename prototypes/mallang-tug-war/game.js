...
function onNewRecord(msg) {
  ...
  card.innerHTML = `
    ...
    <div style="margin:10px 0;font-size:2.6rem;font-weight:900;color:#182338">${msg.score}<span style="font-size:1.1rem">%</span></div>
    ${msg.previousBest != null ? `<div style="font-size:0.88rem;color:rgba(78,52,0,0.72);font-weight:600">이전 기록: ${msg.previousBest}%</div>` : ''}
